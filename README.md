...
- [Добавление и вывод комментариев](#comments)
...
### Добавление и вывод комментариев <a name="comments">

Добавлена возможность добавлять комментарии. Т.к. коментарии привязываются к url страницы, а не к конкретному компоненту(посты, новости и т.д.),  их можно использовать не только для постов, но и для любой страницы на сайте. 
...
## Компоненты <a name="components"/> 
  ...
  - [Комментарии к постам](#component-comments)
...
- `posts` - возвращает **данные** в виде массива, список комментариев постов

#### Структура возвращаемых данных из ``posts``:

<pre><code>array:[
  0 =>BTDev\BlogExtension\Models\Comments{
    {
      "id":1,
      "parent_id":null,
      "user_id":null,
      ...
      "type":null,
      "email":"",
      "created_at":"2025-05-07T09:19:28.000000Z",
      "updated_at":"2025-05-07T09:19:28.000000Z",
      "published_at":"2025-05-07T09:19:28.000000Z"
    } 
  }     
  ...
]</code></pre>

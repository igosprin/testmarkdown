...
Добавлена возможность добавлять комментарии. Т.к. коментарии добавляются по url страницы, их можно использовать не только для постов, но и для любой страницы на сайте. 
